    ...
    return (
        <>
            <div className="d-flex">
                {/* Sidebar */}
                <div className="sidebar bg-dark text-light p-4" style={{ width: '200px' }}>
                    <h3 className="text-center">Admin Dashboard</h3>
                    <ul className="list-unstyled">
                        <li className="py-2"><a href="" className="text-light" onClick={() => navigate(`/AdminDashboard?login=${token_key}&userId=${userId}`)}>Dashboard</a></li>
                        <li className="py-2"><a href="#!" className="text-light">All Products</a></li>
                        <li className="py-2"><a href="#!" className="text-light">Users</a></li>
                        <li className="py-2"><a href="#!" className="text-light">Settings</a></li>
                        <li className="py-2"><a href="#!" className="text-light">Request</a></li>
                        <li className="py-2"><a href="#!" className="text-light" onClick={logout}>Logout</a></li>
                    </ul>
                </div>

                {/* Main Content */}
                <div className="container product-container pt-5" style={{ marginLeft: '200px' }}>
                    <div className="row">
                        {/* Product Image and Thumbnails */}
                        <div className="col-md-6">
                            <div className="product-image text-center">
